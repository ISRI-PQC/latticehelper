...
if [ "$1" = "python" ]; then
    ...
    # Link the C++ wrapper with liboqs, NFLlib and Python+OpenSSL+Intl
    ...
    # Manual working version: g++ -std=c++20 -shared ./swigbuild/python/pqdevkit_wrap.o -L$LIBOQS_ROOT/build/lib -loqs -L$NFL_ROOT/lib -lntl -L/Users/petr/.pyenv/versions/3.11.5/lib -lpython3.11 -L/opt/homebrew/lib -lntl -L/opt/homebrew/opt/openssl@1.1/lib -lssl -lcrypto -o ./swigbuild/python/pqdevkit.so
